...
ADS_Config = {
    ...
    CONSUMABLES = {
        MOTOR_OIL_BURN_RATE = 0.05,                     -- per interval
        MOTOR_OIL_QUALITY_DEGRADATION_RATE = 0.70,
        MOTOR_OIL_CONTAMINATION_RATE = 0.25,
        MOTOR_OIL_DILUTION_RATE = 2.0,
        MOTOR_OIL_OVERLOAD_FACTOR = 0.2,
        MOTOR_OIL_OVERHEAT_FACTOR = 0.5,
        MOTOR_OIL_ENGINE_WEAR_FACTOR = 3.0,
