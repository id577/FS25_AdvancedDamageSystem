ADS_Config = {
    ...
    CORE = {
        ...
        BREAKDOWN_PROBABILITY = {
            -- The base chance (per in-game hour) of a breakdown at 100% condition.
            MIN = 0.03, -- (3% chance per hour)
            -- The maximum chance (per in-game hour) of a breakdown at 0% condition.
            MAX = 0.66, -- (66% chance per hour)
            -- Controls the curve of the probability. Higher value means the chance of breakdown
            -- increases much more sharply as condition drops.
            DEGREE = 1.5,
...
function ADS_Config.saveToXMLFile()
    ...
    setXMLFloat(xmlFile, "advancedDamageSystem.breakdownProbabolityMin", ADS_Config.CORE.BREAKDOWN_PROBABILITY.MIN);
...
function ADS_Config.loadFromXMLFile(mission)
    ...
    if breakdownProb ~= nil then ADS_Config.CORE.BREAKDOWN_PROBABILITY.MIN = breakdownProb end
